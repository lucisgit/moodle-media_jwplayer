...
if ($event->{'type'} == 'setupError' || $event->{'type'} == 'error') {
    ...
    $logevent = \media_jwplayer\event\media_playback_failed::create(array(
        'contextid' => $contextid,
        'other' => $other
    ));
    $logevent->trigger();
    ...
    $logevent = \media_jwplayer\event\media_playback_launched::create(array(
        'contextid' => $contextid,
        'other' => $other
    ));
    $logevent->trigger();
    ...
    $logevent = \media_jwplayer\event\media_playback_completed::create(array(
        'contextid' => $contextid,
        'other' => $other
    ));
    $logevent->trigger();
    ...
    $logevent = \media_jwplayer\event\media_playback_started::create(array(
        'contextid' => $contextid,
        'other' => $other
    ));
    $logevent->trigger();
    ...
    $logevent = \media_jwplayer\event\media_playback_stopped::create(array(
        'contextid' => $contextid,
        'other' => $other
    ));
    $logevent->trigger();
    ...
    $logevent = \media_jwplayer\event\media_playback_position_moved::create(array(
        'contextid' => $contextid,
        'other' => $other
    ));
    $logevent->trigger();
    ...
    $logevent = \media_jwplayer\event\media_qualitylevel_switched::create(array(
        'contextid' => $contextid,
        'other' => $other
    ));
    $logevent->trigger();
    ...
    $logevent = \media_jwplayer\event\media_audiotrack_switched::create(array(
        'contextid' => $contextid,
        'other' => $other
    ));
    $logevent->trigger();
    ...
    $logevent = \media_jwplayer\event\media_captions_switched::create(array(
        'contextid' => $contextid,
        'other' => $other
    ));
    $logevent->trigger();
